...
public:
    ...
    void displayWelcomeBanner() {
        ...
        std::cout << "    |                                                            |" << std::endl;
        setColor(CYAN);
        std::cout << "    |     H   H  OOO   SSS  PPPP  III TTTTT  AAA  L              |" << std::endl;
        std::cout << "    |     H   H O   O S     P   P  I    T   A   A L              |" << std::endl;
        std::cout << "    |     HHHHH O   O  SSS  PPPP   I    T   AAAAA L              |" << std::endl;
        std::cout << "    |     H   H O   O     S P      I    T   A   A L              |" << std::endl;
        std::cout << "    |     H   H  OOO  SSSS  P     III   T   A   A LLLLL          |" << std::endl;
        setColor(MAGENTA);
        std::cout << "    |                                                            |" << std::endl;
        setColor(YELLOW);
        std::cout << "    |          APPOINTMENT BOOKING SYSTEM                        |" << std::endl;
        setColor(MAGENTA);
        std::cout << "    |                                                            |" << std::endl;
        std::cout << "    +============================================================+" << std::endl;
        std::cout << "\n";
